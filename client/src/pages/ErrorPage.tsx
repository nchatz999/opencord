    ...
    <div class="min-h-screen bg-background flex items-center justify-center">
      <div class="bg-sidebar rounded-lg p-8 max-w-md w-full mx-4">
        <div class="text-center">
          ...
          <h2 class="text-xl font-semibold text-primary-foreground mb-4">Connection Lost</h2>
          <p class="text-secondary-text mb-6">{app.error}</p>
          <div class="space-y-3">
            <Button variant="primary" class="w-full" onClick={() => appActions.setView("loading")}>
              Retry Connection
            </Button>
