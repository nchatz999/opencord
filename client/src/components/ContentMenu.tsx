    ...
    <ContextMenuContext.Provider value={{ showContextMenu, hideContextMenu }}>
      ...
      <Show when={isOpen()}>
        <Portal>
          <div
            ref={menuRef}
            class="fixed z-50 min-w-[180px] bg-[#18191c] shadow-lg text-[#dcddde] border border-[#202225]"
    ...
    <div
      ...
      class={cn(
        ...
        merged.disabled
          ...
          : "hover:bg-[#4752c4] hover:text-white",
        merged.danger &&
        !merged.disabled &&
        "text-[#f04747] hover:text-white hover:bg-[#f04747]"
      )}
...
export const ContextMenuSeparator: Component = () => {
  return <div class="h-px bg-[#2f3136] my-1" />;
};
